...
<i>Originally posted 7/15/2016</i>    
...
# Circumstantiality
So we’ve spent a lot of time so far talking about “the typical run.” We [started off](/GroundControl/chapters/ch1/) introducing the concept of the league-average run distribution, [spent some time working with run distributions for particular players](/GroundControl/chapters/ch2/), and then talked about the importance of sample size in [our chapter on resampling and simulation](/GroundControl/chapters/ch4/). But all of that was only done after glossing over [the very first thing we ever said about the run game](/GroundControl/chapters/ch1/#the-central-tendency):  
...
<p><img style="float: left; margin: 0px 4px" src="/GroundControl/images/BernieA.jpg" alt="Bernie" />  “Except for <a href = "/GroundControl/quickhits/divot/" target="_blank">the 10-yard divot on 1st down runs</a>, of course.”</p><br/>  
